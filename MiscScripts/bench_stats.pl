#!/usr/bin/perl
 #*****************************************************************************\
 # FILE: bench_stats.pl
 # DESCRIPTION: This allows reading log files and generating a quick stat about
 # whether they are High,Low or mid (In fact it prints percentages).
 # With respect to states, it shows how long it spent in each state. 
 #
 #*****************************************************************************/
