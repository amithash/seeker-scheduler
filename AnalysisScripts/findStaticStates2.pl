#!/usr/bin/perl
 #*****************************************************************************\
 # FILE: findStaticStates2.pl
 # DESCRIPTION: Find all static layouts with 5 performance states. Print them
 # arrianging them in decreasing order of distance from the existing 
 # (@existing array) layouts.
 #
 #*****************************************************************************/
