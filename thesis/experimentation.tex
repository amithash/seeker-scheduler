...
%  \end{center}
  \caption{Variation of slowdown with delta and interval for the ladder (Subfigure~\subref{fig:slowdown_trends_ladder}) and the select (Subfigure~\subref{fig:slowdown_trends_select}) scheduler}
\end{figure}
