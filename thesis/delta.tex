...
A transition direction of $t = +1$ implies that the scheduler requires a higher performance from
...
and M the total number of performance states available equal to 5,
