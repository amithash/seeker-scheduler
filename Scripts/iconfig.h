/******************************************************************************\
 * FILE: iconfig.h
 * DESCRIPTION: This is the configuration header for interp which instructs
 * it on how to view the log file, what is the primary column (x) what are the
 * dependent variable columns (y1, y2,...).
 *
 \*****************************************************************************/
