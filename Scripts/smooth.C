/******************************************************************************\
 * FILE: smooth.cpp
 * DESCRIPTION: This implements an Auto regressive moving window process to
 * smooth out signals with a lot of noise. Used to generate a smooth graph
 * of the IPC (Or anyother) time series plots.
 *
 \*****************************************************************************/
