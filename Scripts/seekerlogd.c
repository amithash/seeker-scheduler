/******************************************************************************\
 * FILE: seekerlogd.c
 * DESCRIPTION: This is the seeker log daemon which reads in from /dev/seeker_log
 * and dumps the binary content into a log file. It takes in optional parameters
 * for the log file and the polling interval.
 *
 \*****************************************************************************/
