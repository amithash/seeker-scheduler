/******************************************************************************\
 * FILE: maxmin.cpp
 * DESCRIPTION: This takes a set of time series files and generates 2 output 
 * files one being the time series of the maximum and the other the time
 * series of the minimum.
 *
 \*****************************************************************************/
