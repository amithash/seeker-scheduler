/******************************************************************************\
 * FILE: decodelog.c
 * DESCRIPTION: This takes in a binary log spit out by seekerlogd at stdin 
 * and converts it into an ascii (Human and script readable) log file and spits
 * it out to stdout. (Use IO redirections < & >)
 *
 \*****************************************************************************/
